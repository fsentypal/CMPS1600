...
public class Things {
	public enum ThingNames{Sword, Knight1, Knight2, Queen, King, Witch, Bandit, Bread, Coin, GreenPotion, OpenScroll, Farm, SpookyPath, City, Ruins, ForestPath, Tavern, Courtyard, CastleBedroom, DiningRoom, Dungeon, Player} 
